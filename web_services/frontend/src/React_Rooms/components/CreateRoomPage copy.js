...
export class CreateRoomPage extends Component{
    ...
    constructor(props){
        ...
        this.handleCreateRoomClicked= async () => {
            ...
            this.navigate(this.app.concat('room/',data.code,'/'))
            console.log('Navigated wrong')
        }
        this.handleUpdate= async () => {
            ...
            await response.json();
            window.location.href=this.app.concat('room/',this.props.roomCode,'/')
    ...
    componentDidUpdate(){
        console.log(this.state.title, this.state.category,this.state.votesToSkip)
    }
    render(){
        return (
            <div className="RCS_CreateRoom">
                <div className="RCS_CR_Wrapper">
                    ...
                    <div className="RCS_User_Action" id="RCS_User_Action">
                        ...
                        <div><button id = "RCS_Update_Btn"  to={this.app} onClick = {() => this.navigate(this.app)}>Back</button></div>
