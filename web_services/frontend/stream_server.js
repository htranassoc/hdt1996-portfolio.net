...
const http = require('https').Server({
  key: fs.readFileSync(path.join('C:/Projects/Portfolio/webserver/proxy/certs/','key.pem')),
  cert: fs.readFileSync(path.join('C:/Projects/Portfolio/webserver/proxy/certs/','cert.pem'))
},react_server)


const wshttp = require('https').Server({
  key: fs.readFileSync(path.join('C:/Projects/Portfolio/webserver/proxy/certs/','key.pem')),
  cert: fs.readFileSync(path.join('C:/Projects/Portfolio/webserver/proxy/certs/','cert.pem'))
},react_server)
...
const io = require('socket.io')(http,{
  ...
  cors:true,
  cors: {
    origin: ['https://hdt1996-portfolio.me:8001',],
    credentials:true,
    methods: ["GET", "POST"]},
